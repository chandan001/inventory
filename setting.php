	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form action="php_action/createuser.php" method="post" class="form-horizontal" id="createUser">
					<fieldset>
						<legend>Add User</legend>

						<div class="addUserMessages"></div>			

						<div class="form-group">
					    <label for="username" class="col-sm-2 control-label">Username</label>
					    <div class="col-sm-10">
					      <input type="text" class="form-control" id="uname" name="uname" placeholder="Usename" />
					    </div>
					  </div>
					  ...
					  <div class="form-group">
						...
						//	$uname=$_POST['uname'];
							...
							?>
					      <button type="submit" class="btn btn-primary" onclick="myFunction()"> <i class="glyphicon glyphicon-ok-sign"></i> Add User </button>
